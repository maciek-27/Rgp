...
namespace Scr
{
	...
	namespace TI
	{
		...
		/*!
		  ordering of booleans in compiled terminfo file. This is
		  based on /usr/include/term.h, by Zeyd M. Ben-Halim, Eric
		...
		/*!
		  ordering of numbers in compiled terminfo file. This is
		  based on /usr/include/term.h, by Zeyd M. Ben-Halim, Eric
		  S. Raymond and Thomas E. Dickey.
		 */
		enum Numbers
		...
		/*!
		  ordering of strings in compiled terminfo file. This is
		  based on /usr/include/term.h, by Zeyd M. Ben-Halim, Eric
		  S. Raymond and Thomas E. Dickey.
		 */
		enum Strings
