#ifndef __FILENO_HACK__
#define __FILENO_HACK__

/*! \file fileno_hack.h++
  \brief extract file descriptor from C++ stream.
  Author of this code is Richard B. Kreckel
*/
...
//!
//! \param stream a C++-style stream to extract FD from
